  ...
  return (
    <div className="body">
      ...
      <div className="info-container">
        <div className="box">
          <h3 id="experience">Computer Science Department Grader</h3>
        ...
        <div className="box">
          <h3 id="experience">HackHolyoke Hackathon Best Sustainability Hack</h3>
        ...
        <div className="box">
          <h3 id="experience">Heptology Laboratory Intern</h3>
